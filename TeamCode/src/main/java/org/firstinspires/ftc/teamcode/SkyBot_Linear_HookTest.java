...
@TeleOp(name="SkyBot Op Mode - Hook Test",group="Linear")
//@Disabled
public class SkyBot_Linear_HookTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            rightHookPos=rightHookPos+(gamepad2.right_stick_y*servoMul);
            leftHookPos=leftHookPos+(gamepad2.left_stick_y*servoMul);
        ...
        telemetry.addData("Hooks", "left (%.2f), right (%.2f)", leftHookPos, rightHookPos);
        telemetry.update();
        }
    }
}